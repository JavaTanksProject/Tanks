...
public class TankCannon extends PhysObj {
    ...
    public void move(double aim_angle, TankHead tank_head) {
        ...
        this.x = tank_head.x+0.055*(Math.cos(angle));
        this.y = tank_head.y+0.055*(Math.sin(angle));
...
//        StdDraw.filledCircle(x,y,0.01);
        StdDraw.picture(this.x, this.y, this.picturepath, 0.15, 0.03, this.angle * 57.29);
    }
}
